...
for (Ticker in ticker_cols) {
  ...
  # Create data for VAR
  print(Ticker)
  data_for_var <- cbind(war_interest=war_ticker_inflation_df$hits, ticker=war_ticker_inflation_df[[Ticker]], inflation=war_ticker_inflation_df$AVG_INFLATION)
