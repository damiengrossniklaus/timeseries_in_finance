...
var_ticker[order(var_ticker[,1], decreasing=FALSE),]
```


## 5. Conclusion

This paper was looking into the effect of war on the performance of two sector specific indices. Specifically, the hypotheses was, that the materials and industrial sector are profiteers of war. To verify this hypotheses a vector autoregression including inflation as control variable was performed. The Granger causality test didn't show a significant effect of war on the two sectors. Therefore the hypotheses couldn't be confirmed.
